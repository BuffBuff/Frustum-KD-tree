...
FRTGraphics::FRTGraphics(HWND* _hwnd)
	: m_mesh(Mesh()),
...
void FRTGraphics::createCBuffers()
{
	HRESULT hr = S_OK;
...
void FRTGraphics::createTriangleTexture()
{
	///////////////////////////////////////////////////////////////////////////////////////////
	//Mesh
	///////////////////////////////////////////////////////////////////////////////////////////
...
void FRTGraphics::createNodeBuffer(Node* _rootNode)
{
...
void FRTGraphics::createLightBuffer()
{
...
void FRTGraphics::createSwapStructures()
{
...
FRTGraphics::~FRTGraphics()
{
}

void FRTGraphics::Update(float _dt)
{
...
void FRTGraphics::Render(float _dt)
{
	//set shader
	raytracer->Set();
...
void FRTGraphics::createKdTree(Mesh *_mesh)
{

}

void FRTGraphics::updateTogglecb(int _lightSpheres, int _placeHolder1, int _placeHolder2)
{
